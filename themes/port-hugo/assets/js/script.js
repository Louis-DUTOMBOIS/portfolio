(function ($) {
  ...
  function toggleLogoImg(id) {
    ...
    if (img.indexOf('L-removebg-preview.png') != -1) {
      document.getElementById(id).src = '/images/L__2_-removebg-preview.png';
    } else {
      document.getElementById(id).src = '/images/L-removebg-preview.png';
    }
  }
